...
export function Testimonials() {
  const testimonials = [
    {
      content: "This AI platform has transformed my life. I've made more progress in months than I did in years of traditional therapy.",
      author: "Sarah M.",
      role: "Software Engineer",
      image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
    },
    {
      content: "As a speech therapist, I recommend this platform to all my patients. It's like having a personal coach available 24/7.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {testimonials.map((testimonial) => (
            <div key={testimonial.author} className="bg-brand-50 p-8 rounded-xl shadow-sm">
